AFRAME.registerComponent("atoms", {
  ...
  createAtoms: async function (element) {
    ...
    for (var i = 1; i <= numOfElectron; i++){
      ...
      group.setAttribute("id", `group-${elementName}`);
  
      group.setAttribute("animation", {property: "rotation", dur: 3500, easing: "linear", loop : "true", to : `0 0 -360`} );
  
      group.setAttribute("rotation", { x: 0, y: 0, z: electronAngle });
      ...
      electron.setAttribute("material", {"color": "#ff9e80", "opacity": 0.6});
